<template>
	<div id="app" class="container">
		...
		<b-button @click.prevent="obterUsuarios" size="lg" variant="success" class="ml-4">Obter usuários cadastrados</b-button>
		</b-card>
		<hr>
		<b-list-group>
			<b-list-group-item v-for="(usuario, id) in usuarios" :key="id">
				...
				<b-button variant="danger" size="lg" class="ml-4" @click="excluir(id)">Deletar</b-button>
			</b-list-group-item>
		</b-list-group>
	</div>
</template>
